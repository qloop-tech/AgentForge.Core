...
## 10.3 Validation and Publish Pipeline

The parent Aspire AppHost owns local orchestration and Docker Compose publishing. Validate runtime changes with backend tests, dashboard build, and Aspire resource health checks. Deployment automation should live at the AgentForge repository level rather than inside the OpenWA source tree.
