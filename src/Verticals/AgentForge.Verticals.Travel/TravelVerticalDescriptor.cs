...
public sealed class TravelVerticalDescriptor : IVerticalDescriptor
{
    public string VerticalId => "travel";
    public string DisplayName => "Royal Journeys";
    public string AgentName => "Aria";
    public string AgentDescription => "Royal Journeys AI Travel Consultant";
    public string SystemPrompt => Prompt;
    public string McpServerName => "RoyalJourneysMCP";
    public string AssetPathPrefix => "/images/";
    public string PreviewTitle => "Royal Journeys";
    public string PreviewDescription => "Discover amazing tour packages with Royal Journeys.";
